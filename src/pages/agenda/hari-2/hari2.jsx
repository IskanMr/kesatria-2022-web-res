...
export function HariKedua ({time, title, deskripsi, go}) {
    const buttonAll = "group border-6 border-blue-default flex-row shrink rounded-3xl grow py-4 lg:py-0 ";
    const titleAgenda = 'font-gill text-3xl font-bold text-blue-default w-full';
    const deskripsiAgenda = 'font-gill text-2xl text-judul text-blue-default min-w-96';
    const timeAgenda= "w-32 lg:h-14 h-12 my-auto flex place-content-center bg-blue-default text-white font-gill font-bold text-2xl md:text-3xl py-2 md:mt-4 rounded-2xl mx-9 agenda:mx-6 lg:my-9";
    const buttonGoAll = "group border-6 border-blue-default block flex-row rounded-3xl hover:bg-blue-default w-1100 grow cursor-pointer py-4 md:py-0";
    const titleGoAgenda = 'font-gill text-3xl font-bold text-blue-default group-hover:text-white';
    const deskripsiGoAgenda = 'font-gill text-2xl text-judul text-blue-default group-hover:text-white min-w-96';
