            ...
            >
                <GenericPage>
                    ...
                    >
                        ...
                        >
                            <div className='overflow-hidden w-[45vmin] h-[25vmin] flex absolute right-0 top-[11vh] md:top-[17vh] md:right-[0] '>
                                <img
                                    className='w-100 h-100 z-[3] flex absolute scale-[70%] md:scale-[78%] right-[1vw] md:right-[1vw]'
                                    src={cloud}
                                    alt=''
                                />
                            </div>
                            <div className='overflow-hidden w-[45vmin] h-[25vmin] hidden absolute left-0 998px:bottom-[-11vh] 998px:flex'>
                                <img
                                    className='w-100 h-100 z-[3] flex absolute scale-[70%] md:scale-[78%] 998px:left-[0vw]'
                                    src={cloud}
                                    alt=''
                                />
                            </div>
