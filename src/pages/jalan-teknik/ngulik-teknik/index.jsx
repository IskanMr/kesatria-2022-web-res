            ...
            <div
                ...
                <GenericPage>
                    ...
                    <div className={`${styles.videoContainer} 998px:flex-row mt-[-1rem]`}>
                        <div className="overflow-hidden w-[45vmin] h-[25vmin] flex absolute right-0 top-[10vh] md:top-[11.5vh] md:right-[0] ">
                        ...
                        <div className="overflow-hidden w-[45vmin] h-[25vmin] flex absolute left-0 bottom-[-16vh] 998px:bottom-[-12vh]">
                        ...
                        <div className="container bg-[#224860] p-[1.5rem] h-[130vmin] w-[100%] 998px:h-[65vmin] 998px:w-[33.5%] rounded-2xl z-3">
                            <iframe style={{ width: '100%', height: '100%' }} title="livechat" allowFullScreen="" frameBorder="0" height="270" src={`https://www.youtube.com/live_chat?v=UE6_A7amZ5w&embed_domain=${Domain}`} width="480" />
                        </div>
                    </div>
