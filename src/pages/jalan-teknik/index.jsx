    ...
    const Children = [
        <>
            <div className='card-one w-[45vw] 768px:w-[65vw] flex-col flex justify-center px-[3rem] 768px:px-[1rem]'>
                <h3 className='font-gill font-bold text-white text-center text-[4vmin] 1024px:text-[3.5vmin] 768px:text-[4.5vmin] my-[1.5rem]'>
                    NGULIK TEKNIK
                </h3>
                ...
                <p className='font-gill font-bold text-white text-center text-[3vmin] 1024px:text-[2.5vmin] 768px:text-[3vmin] mb-[1.5rem] 768px:my-[1.5rem]'>
                ...
                <div className='button-container justify-center items-center flex flex-row'>
                    <div className=' text-white text-[3vmin] md:text-[3vmin] mb-[1.5rem]'>
                        <button
