...
export function Penugasan() {
    ...
    if(location.pathname === "/penugasan/hari-1" || location.pathname === "/penugasan"){
    ...
    return (
                ...
                <><HtmlHead title='Penugasan' decription='Yes' /><div
                ...
                <div className="container mx-auto px-auto w-5/6 place-items-center flex flex-col grow">
                    <Router>
                        <div id="agenda-hari" className='mx-auto flex flex-row mt-10'>
                            <Link to={`${path}/hari-1`}>
                                <button type='button' id="hari1" className={cssDay1} onClick={() => { changeDay1(clicked); changeDay2(unClicked); } }>
                                    Hari 1
                                </button>
                            </Link>
                            <Link to={`${path}/hari-2`}>
                                <button type='button' id="hari2" className={cssDay2} onClick={() => { changeDay2(clicked); changeDay1(unClicked); } }>
                                    Hari 2
                                </button>
                            </Link>
                        </div>
